...
const SensorsData = ({blocEnCours, newProduct, setNewProduct}) => {
    ...
    useEffect(() => {
        const{  hauteurInputValue,
                longueurInputValue,
                largeurInputValue,
                poidsInputValue,
                densiteInputValue,
                validationInputValue } = formValue;
        
        const isValid = (hauteurInputValue > 0) && (longueurInputValue > 0) && (largeurInputValue > 0) && (poidsInputValue > 0) && (densiteInputValue > 0) && (validationInputValue > 0) && (blocEnCours?.blocName ? true : false) && (blocEnCours?.genre?.intitule ? true : false);
        ...
        <>
            <div className='sensors-data-container'>
                <div className='sensors-input-box'>
                    ...
                    />
                    <span> 
                        { (formValue.hauteurInputValue > 0)? <CheckSquareOutlined style={{fontSize: '30px', color: 'green'}} /> 
                ...
                <div className='sensors-input-box'>
                    ...
                    <input 
                        ...
                        onChange={(event) => handleCapteursChange(event)}  />
                    <span> 
                        {(formValue.longueurInputValue > 0) ? <CheckSquareOutlined style={{fontSize: '30px', color: 'green'}} /> 
                                        : <CloseSquareOutlined style={{fontSize: '30px', color: 'red'}} /> }
                    </span> 
                </div>
                ...
                <div className='sensors-input-box'>
                    ...
                    />
                    <span> 
                        {(formValue.largeurInputValue > 0) ? <CheckSquareOutlined style={{fontSize: '30px', color: 'green'}} /> 
                                        : <CloseSquareOutlined style={{fontSize: '30px', color: 'red'}} /> }
                    </span> 
                </div>
                ...
                <div className='sensors-input-box'>
                    ...
                    <input 
                        ...
                        step={0.01} onChange={(event) => handleCapteursChange(event)} 
                    />
                    <span> 
                        {(formValue.poidsInputValue > 0) ? <CheckSquareOutlined style={{fontSize: '30px', color: 'green'}} /> 
                                        : <CloseSquareOutlined style={{fontSize: '30px', color: 'red'}} /> }
                    </span> 
                </div>
                ...
                <div className='sensors-input-box'>
                    ...
                    />
                    <span>
                        {(formValue.densiteInputValue > 0) ? <CheckSquareOutlined style={{fontSize: '30px', color: 'green'}} /> 
                                        : <CloseSquareOutlined style={{fontSize: '30px', color: 'red'}} /> }
                    </span> 
                </div>
                ...
                <div className='sensors-input-box'>
                    ...
                    />
                    <span> 
                        { blocEnCours?.blocName ? <CheckSquareOutlined style={{fontSize: '30px', color: 'green'}} /> 
                                                : <CloseSquareOutlined style={{fontSize: '30px', color: 'red'}} /> }
                    </span> 
                </div>
                ...
                <div className='sensors-input-box'>
                    ...
                    <input 
                        ...
                        onChange={(event) => handleCapteursChange(event)} />
                    <span> 
                        { blocEnCours?.genre?.intitule  ? <CheckSquareOutlined style={{fontSize: '30px', color: 'green'}} /> 
                                                        : <CloseSquareOutlined style={{fontSize: '30px', color: 'red'}} /> }
                    </span> 
                </div>
                ...
                <div className='sensors-input-box'>
                    ...
                    />
                    <span> 
                        { (formValue.validationInputValue > 0)  ? <CheckSquareOutlined style={{fontSize: '30px', color: 'green'}} /> 
                                            : <CloseSquareOutlined style={{fontSize: '30px', color: 'red'}} /> }
                    </span>
                </div>
            </div>
